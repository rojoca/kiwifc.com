...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Selection.subbed_on'
        db.delete_column(u'fixtures_selection', 'subbed_on')

        # Deleting field 'Selection.subbed_off'
        db.delete_column(u'fixtures_selection', 'subbed_off')


    def backwards(self, orm):
        # Adding field 'Selection.subbed_on'
        db.add_column(u'fixtures_selection', 'subbed_on',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Selection.subbed_off'
        db.add_column(u'fixtures_selection', 'subbed_off',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
