...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'manager_matchreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fixture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fixtures.Fixture'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['club.SquadMember'])),
            ('report', self.gf('django.db.models.fields.TextField')()),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'manager', ['MatchReport'])

        # Adding model 'Fine'
        db.create_table(u'manager_fine', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fixture', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fines', null=True, to=orm['fixtures.Fixture'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['club.SquadMember'])),
            ('amount', self.gf('django.db.models.fields.IntegerField')(default=50)),
            ('reason', self.gf('django.db.models.fields.TextField')(null=True)),
            ('created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'manager', ['Fine'])

        # Adding model 'Prematch'
        db.create_table(u'manager_prematch', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fixture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fixtures.Fixture'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['club.SquadMember'])),
            ...
            ('beer', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
        ))
        db.send_create_signal(u'manager', ['Prematch'])


    def backwards(self, orm):
        # Deleting model 'MatchReport'
        db.delete_table(u'manager_matchreport')

        # Deleting model 'Fine'
        db.delete_table(u'manager_fine')

        # Deleting model 'Prematch'
        db.delete_table(u'manager_prematch')
